...
let LandingPage = () => {
  ...
  return (
    <div>
      <header>
        <nav>
          <a href="/" target="_self"><label className="logo">Liam Sullivan</label></a>
          <ul>
            <li><a href="/" className="button" target="_self">About</a></li>
            <li><a href="resume" className="button" target="_self">Resumé</a></li>
            <li><a href="photography" className="button" target="_self">Photography</a></li>
            <li><a href="projects" className="button" target="_self">Projects</a></li>
            <li><a href="contact" className="button" target="_self">Contact</a></li>
          </ul>
        </nav>
      </header>
      <main>
        <div className="container">
          <img src="Images/me.jpg" alt="Liam Sullivan" className="photo" /><br />
          <div className="text">
